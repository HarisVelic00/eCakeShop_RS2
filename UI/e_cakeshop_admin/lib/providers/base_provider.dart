// ignore_for_file: unnecessary_cast, prefer_interpolation_to_compose_strings, unnecessary_brace_in_string_interps, non_constant_identifier_names, curly_braces_in_flow_control_structures
...
class BaseProvider<T> with ChangeNotifier {
  ...
  BaseProvider(String endpoint) {
    _baseUrl = const String.fromEnvironment("baseUrl",
        defaultValue: "http://localhost:7166/");
