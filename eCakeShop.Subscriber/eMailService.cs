...
namespace eCakeShop.Subscriber
{
    public class EmailService
    {
        ...
        public void SendEmail(string message)
        {
            try
            {
                ...
                string fromMail = Environment.GetEnvironmentVariable("SMTP_USERNAME") ?? "ecakeshop@outlook.com";
                string password = Environment.GetEnvironmentVariable("SMTP_PASSWORD") ?? "password2000";
